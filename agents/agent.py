...
class Critic:
    ...
    def build_model(self):
        ...
        net_states = layers.Dense(units=256, activation='relu', kernel_regularizer=layers.regularizers.l2(1e-6))(net_states)
        ...
        net_actions = layers.Dense(units=256, activation='relu', kernel_regularizer=layers.regularizers.l2(1e-6))(net_actions)
